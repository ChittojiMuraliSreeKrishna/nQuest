...
export class RecieveOrder extends Component {
  constructor(props) {
    super(props);
    this.state = {
      filterActive: false,
          ...
          <FlatList
            ListHeaderComponent={
              <View style={scss.headerContainer}>
                <Text style={scss.flat_heading}>Received Orders - <Text style={{ color: '#ED1C24' }}>{this.state.recieveOrdersList.length}</Text> </Text>
                <IconFA
                  name='sliders'
                  size={25}
