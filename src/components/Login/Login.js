					...
					<SafeAreaView>
						<View style={scss.mainContainer}>
							...
							{/* <Image
								...
								style={
									Device.isTablet
										? styles.bottomImage_tablet
										: styles.bottomImage_mobile
								}
							/> */}
							<View
								style={{ flex: 1, backgroundColor: "#FFFFFF", marginTop: 40 }}
							>
								<Text
									style={
										Device.isTablet
											? styles.headerText_tablet
											: styles.hederText_mobile
									}
								>
									Login Now
								</Text>
								<Text>Let's explore the best</Text>
							</View>
							...
							<View style={{ flex: Device.isTablet ? 4 : 7 }}>
								<TextInput
									style={[
										inputField,
										{ borderColor: userValid ? "#8F9EB717" : "#dd0000" },
									]}
								...
								<TextInput
									style={[
										inputField,
										{ borderColor: passValid ? "#8F9EB717" : "#dd0000" },
									]}
									underlineColorAndroid="transparent"
									...
									<View
										style={{
											...
											justifyContent: Device.isTablet
												? "space-around"
												: "center",
											alignItems: Device.isTablet ? "center" : "center",
										}}
									>
										<View
											style={{
										...
										>
											...
											<TouchableOpacity onPress={() => this.registerClient()}>
												<Text
													style={
														Device.isTablet
